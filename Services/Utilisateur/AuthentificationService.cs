...
//         public async Task<(bool success, string message)> inscrireUtilisateurAvecEmailAuto(RegisterDto registerDto)
//         {
//             if (await _context.utilisateurs.AnyAsync(u => u.matricule == registerDto.matricule))
//                 return (false, "User already exists");

//             string generatedPassword = genererMDP();
//             byte[] passwordHash = hasherMDP(generatedPassword);
...
//                 await envoyerInfosParEmail(user.matricule, user.nom_complet, generatedPassword);
                
//                 return (true, "User created successfully and credentials sent via email");
//             }
//             catch (Exception ex)
//             {
