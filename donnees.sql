...
INSERT INTO mapping_colonnes (colonne_excel, colonne_bdd, table_prod, type_donnee_prod) VALUES
('cli', 'participant_cli', 'intervenants', 'string'),
('date_declaration', 'date_declaration', 'credits', 'dateonly'),
('type_cle', 'participant_type_cle', 'intervenants', 'string'),
('cle', 'participant_cle', 'intervenants', 'string'),
('nifd', 'participant_nif', 'intervenants', 'string'),
('cle_int', NULL, NULL, 'string'),
('cle_onomastique', NULL, NULL, 'string'),
('niveau_respons', 'role_niveau_responsabilite', 'intervenants_credits', 'string'),
('plafond_accorde', NULL, 'credits', 'bool'),
('numero_contrat', 'numero_contrat', 'credits', 'string'),
('dev', 'monnaie', 'credits', 'string'),
('rib', 'participant_rib', 'intervenants', 'string'),
('cpay', 'code_pays', 'lieux', 'string'),
('age', 'code_agence', 'lieux', 'string'),
('code_wilaya', 'code_wilaya', 'lieux', 'string'),
('code_act_credit', 'activite_credit', 'credits', 'string'),
('type_credit', 'type_credit', 'credits', 'string'),
('situation_credit', 'situation_credit', 'credits', 'string'),
('classe_retard', 'classe_retard', 'credits', 'string'),
('duree_init', 'duree_initiale', 'credits', 'string'),
('duree_restante', 'duree_restante', 'credits', 'string'),
('credit_accorde', 'credit_accorde', 'credits', 'decimal'),
('solde_restant', 'solde_restant', 'credits', 'decimal'),
('cout_credit', 'cout_total_credit', 'credits', 'decimal'),
('mensualite', 'mensualite', 'credits', 'decimal'),
('taux', 'taux', 'credits', 'decimal'),
('date_impaye', 'date_constatation', 'credits', 'date'),
('nombre_impaye', 'nombre_echeances_impayes', 'credits', 'int'),
('montant_nom_rmb', 'montant_interets_courus', 'credits', 'decimal'),
('montant_cap_retard', 'montant_capital_retard', 'credits', 'decimal'),
('montant_int_retard', 'montant_interets_retard', 'credits', 'decimal'),
('date_rejet', 'date_rejet', 'credits', 'date'),
('date_octroi', 'date_octroi', 'credits', 'date'),
('date_expi', 'date_expiration', 'credits', 'date'),
('type_garantie', 'type_garantie', 'garanties', 'string'),
('montant_garantie', 'montant_garantie', 'garanties', 'decimal'),
('type_credit_declare', NULL, NULL, 'string'),
('numero_plafond', 'id_plafond', 'credits', 'string'),
('statut', NULL, NULL, 'string'),
('motif', 'motif', 'credits', 'string'),
('date_exe', 'date_execution', NULL, 'date');
