...
namespace DCCR_SERVER.DTOs
{
    public class ApercuCreditDto
    {
        ...
        public List<apercuParticipantDto> Participants { get; set; }
        public List<apercuGarantieDto> Garanties { get; set; }
    }

    public class apercuParticipantDto
    {
    ...
    public class apercuGarantieDto
    {
